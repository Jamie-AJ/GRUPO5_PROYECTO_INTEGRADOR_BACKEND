...
public class OportunidadUsuario {
	...
	private OportunidadInversion idOportunidad;
	...
	public OportunidadInversion getIdOportunidad() {
	...
	public void setIdOportunidad(OportunidadInversion idOportunidad) {
	...
	public OportunidadUsuario(int idOportunidadUsuario, OportunidadInversion idOportunidad, int montoInvertido,
